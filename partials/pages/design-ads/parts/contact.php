...
<section class="min-h-72 py bg-gradient-to-r from-[#18181a] via-[#001922] to-[#003041]">
    ...
    <div class="container">
        ...
        <div class="flex flex-row gap-16 justify-center items-center lg:px-28 py-12 max-md:flex-col">
            ...
            <div class="w-7/12 max-md:w-4/5">
                ...
                <div class="flex gap-1 items-center">
                    <div class="rotate-180 size-10">
                        <?php Icon::print('Arrow,-Location-,-Direction'); ?>
                    </div>

                    <p class="text-base font-normal"><?php echo $contact_subtitle ?></p>
                </div>

                <p class="text-4xl md:text-5xl font-bold mt-3 mb-6"><?php echo $contact_title ?></p>
