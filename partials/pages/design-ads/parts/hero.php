...
<section class="relative overflow-hidden">
    ...
    <?php echo wp_get_attachment_image($hero_image_ribbon, 'full', false, ['class' => 'absolute top-[75%] max-md:top-[78%] -z-10 -rotate-[7deg] left-0 -right-10 min-w-[120vw] max-md:min-w-[270vw]']); ?>

    <div class="flex flex-col-reverse md:flex-row justify-between items-center container">

        <div class="md:w-1/2 md:pr-10 md:pb-14">
            ...
            <h1 class="max-md:text-4xl max-lg:text-[2.75rem] max-xl:text-6xl xl:text-7xl font-bold text-right leading-tight flex flex-col gap-4 top-10">
                <span><?php echo ($hero_short_title); ?></span>
